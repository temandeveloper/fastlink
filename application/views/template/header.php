...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>\asset\fontawesome\css\all.css">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-header fixed-top shadow">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>#Programming">Programming</a></li>
