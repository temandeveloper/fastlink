  ...
  <body>
    <div class="container">
      <div class="title-side">
        <h3>Memasukan Kutipan</h3>
      </div>
      <div class="content">
          <?php echo form_open_multipart('MainController/slideupdate/'.$slide_item['id']);?>
          <table>
                <tr>
                  <td><input type="text" name="nama" class="input" placeholder="Masukan Nama" required=""></td>
                </tr>
                <tr>
